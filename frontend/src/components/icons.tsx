/**
 * Inline SVG icons used across the UI. Each takes an optional `className` so
 * callers control size and colour via Tailwind (icons stroke/fill with
 * `currentColor`). Kept in one place so the components stay free of SVG noise.
 */
...
export function IconOrchestrator({ className = "" }: IconProps) {
  return (
    <svg className={className} width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
/** Maps a graph agent name to the icon shown for its pipeline node. */
export const STAGE_ICONS: Record<string, (props: IconProps) => React.ReactElement> = {
